<%@ Page Language="C#" Debug="true" AutoEventWireup="true" CodeBehind="PersonelVeriGirisWizard.aspx.cs" Inherits="ITP247.PersonelVeriGirisWizard" %>
...
<table class="auto-style3">
            ...
            <tr>
                <td class="auto-style5">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:con_Personeller %>" 
                        ...
                        <WizardSteps>
                            <asp:WizardStep runat="server" title="Kişisel Veriler">
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style8"><asp:TextBox ID="TextBox3" runat="server" Width="110px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style13">Giriş Tarihi:</td>
                                        <td class="auto-style8"><asp:TextBox ID="TextBox4" runat="server" Width="220px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style13">Ünvanı:</td>
                                            <td class="auto-style8">
                                                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="Unvan" DataValueField="Kategori_ID" Height="16px" Width="132px">
                                                </asp:DropDownList>
                                        </td>
                                    </tr>
                                        <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:con_Personeller %>" SelectCommand="SELECT Kent_Adi FROM tbl_Kategoriler WHERE (NOT (Kent_Adi IS NULL))"></asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:con_Personeller %>" SelectCommand="SELECT Il_Adi FROM tbl_Kategoriler WHERE (NOT (Il_Adi IS NULL)) ORDER BY Il_Adi"></asp:SqlDataSource>
                    </td>
            </tr>
            <tr>
                <td class="auto-style4">
